...
call sp_AgregarProveedores(2, '26789543', 'Maria', 'Gomez', 'Guatemala', 'Productos frescos', '45673298', 'http://www.mariagomez.com');
call sp_AgregarProveedores (3, '34567890', 'Juan', 'Perez', 'Mixco', 'Suministros industriales', '78901234', 'http://www.juanperez.com');
call sp_AgregarProveedores(4, '43218907', 'Ana', 'Lopez', 'Quetzaltenango', 'Materiales de construcción', '89012345', 'http://www.analorena.com');
call sp_AgregarProveedores(5, '58907643', 'Pedro', 'Ramirez', 'Escuintla', 'Artículos de hogar', '90123456', 'http://www.pedroramirez.com');
call sp_AgregarTipoProducto(1, 'Lácteos');
call sp_AgregarTipoProducto(2, 'Frutas y Verduras');
call sp_AgregarTipoProducto(3, 'Productos de limpieza');
call sp_AgregarTipoProducto(4, 'Carnes y Aves');
call sp_AgregarTipoProducto(5, 'Panadería y Pastelería');
call sp_AgregarCompras(1,'2024/01/01','Es una vaquita',0);
call sp_AgregarCompras(2, '2024/01/01', 'Es una manzana', 0);
call sp_AgregarCompras(3, '2024/01/01', 'Es un detergente', 0);
call sp_AgregarCompras(4, '2024/01/01', 'Es una pechuga de pollo', 0);
call sp_AgregarCompras(5, '2024/01/01', 'Es un pan de chocolate', 0);
call sp_AgregarCargoEmpleado(1,'Jefatura','Ser lider de un equipo de trabajo');
call sp_AgregarProducto('ABC123', 'Leche entera', 0.00, 0.00, 0.00, '', 100, 1, 1);
call sp_AgregarProducto('DEF456', 'Manzana Gala', 0.00, 0.00, 0.00, '', 200, 2, 2);
call sp_AgregarProducto('GHI789', 'Detergente líquido', 0.00, 0.00, 0.00, '', 50, 3, 3);
call sp_AgregarProducto('JKL012', 'Pechuga de pollo', 0.00, 0.00, 0.00, '', 150, 4, 4);
call sp_AgregarProducto('MNO345', 'Pan de chocolate', 0.00, 0.00, 0.00, '', 80, 5, 5);
call sp_AgregarDetalleCompra(1, 5.99, 10, 'ABC123', 1);
call sp_AgregarDetalleCompra(2, 1.50, 20, 'DEF456', 2);
call sp_AgregarDetalleCompra(3, 8.99, 5, 'GHI789', 3);
call sp_AgregarDetalleCompra(4, 6.75, 15, 'JKL012', 4);
call sp_AgregarDetalleCompra(5, 2.25, 8, 'MNO345', 5);
call sp_AgregarEmpleados(1,'Derian Sebastian','Hernandez Gonzalez',2000,'Ciudad Quetzal','Vespertino',1);
call sp_AgregarFactura(1,'Canelada',0,'2024/01/09',1,1);
call sp_AgregarDetalleFactura(1, 5.99, 10, 1, 'ABC123');
call sp_AgregarDetalleFactura(2, 1.50, 20, 1, 'DEF456');
call sp_AgregarDetalleFactura(3, 8.99, 5, 1, 'GHI789');
call sp_AgregarDetalleFactura(4, 6.75, 15, 1, 'JKL012');
call sp_AgregarDetalleFactura(5, 2.25, 8, 1, 'MNO345');
call sp_AgregarUsuario('RinTohsaka','Samedirection14',2);
